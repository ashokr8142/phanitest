...
module "my_studies_consent_documents_bucket" {
  ...
  name        = "heroes-hat-unc-dev-my-studies-consent-documents"
...
module "my_studies_fda_resources_bucket" {
  ...
  name        = "heroes-hat-unc-dev-my-studies-fda-resources"
  project_id  = var.project_id
  location    = var.storage_location
...
module "my_studies_institution_resources_bucket" {
  ...
  name        = "heroes-hat-unc-dev-my-studies-institution-resources"
  project_id  = var.project_id
  location    = var.storage_location
...
module "my_studies_firestore_data_bigquery" {
  ...
  dataset_id = "heroes_hat_unc_dev_my_studies_firestore_data"
  project_id = var.project_id
  location   = var.storage_location
}
